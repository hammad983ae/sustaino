  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        /* Enhanced ESG Colors - Added subtly */
        success: {
      ...
      keyframes: {
        ...
        "green-glow": {
          "0%, 100%": {
            boxShadow: "0 0 20px hsl(var(--green-glow) / 0.3)"
          },
          "50%": {
            boxShadow: "0 0 40px hsl(var(--green-glow) / 0.5), 0 0 60px hsl(var(--green-glow) / 0.2)"
          }
        },
        "float-3d": {
          "0%, 100%": {
        ...
        "green-pulse": {
          "0%, 100%": {
            backgroundColor: "hsl(var(--green-medium) / 0.8)"
          },
          "50%": {
