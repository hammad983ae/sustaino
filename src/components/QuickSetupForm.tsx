...
export default function QuickSetupForm({ onComplete, onAdvancedSetup }: QuickSetupFormProps) {
  ...
  const handleQuickStart = async () => {
    ...
    // Auto-complete the 8 core steps behind the scenes for quick setup
    try {
      setTimeout(() => {
        const setupData = {
          preset: preset,
          ...
          // Pre-completed 8 core steps data
          coreStepsData: {
            propertyAddress: { completed: true, data: { propertyAddress: address } },
            planningSearch: { completed: true, data: { autoGenerated: true } },
            searchAnalysis: { completed: true, data: { autoGenerated: true } },
            photosDocuments: { completed: false, data: null }, // User can add later
            reportConfig: { completed: true, data: preset },
            rentalConfig: { completed: preset.reportType.includes('investment'), data: preset },
            intelligentEnhancement: { completed: true, data: { autoEnabled: true } },
            reviewGenerate: { completed: false, data: null } // Will be completed in next step
          },
          
          // Ready for streamlined assessment
          proceedToStreamlined: true,
          
          // Store data for auto-generation
          reportConfig: {
