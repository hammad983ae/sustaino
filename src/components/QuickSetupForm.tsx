...
export default function QuickSetupForm({ onComplete, onAdvancedSetup }: QuickSetupFormProps) {
  ...
  const handleQuickStart = async () => {
    ...
    // Simulate quick property analysis
    setTimeout(() => {
      const setupData = {
        preset: preset,
        ...
        quickSetup: true,
        // Pre-populate all configuration based on preset
        reportConfig: {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="text-center text-sm text-muted-foreground bg-muted/30 rounded-lg p-4">
        <p className="font-medium mb-1">Quick Setup Benefits:</p>
        <p>✓ 2-minute setup vs 15+ minutes • ✓ Pre-configured templates • ✓ Same quality review process</p>
      </div>
    </div>
  );
}