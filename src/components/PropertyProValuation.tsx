        ...
        <TabsContent value="property-summary" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
                ...
                {formData.reportType === 'AS IF COMPLETE' && (
                  <>
                    ...
                    <div className="bg-orange-50 border-orange-200 p-4 space-y-4">
                      ...
                      {/* Building Cost Analysis Section */}
                      <div className="border-t border-orange-300 pt-4 mt-4">
                        <h4 className="text-lg font-semibold mb-4 text-orange-800">Building Cost Analysis</h4>
                        
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <Label htmlFor="buildingCost">Building Cost (from Contract)</Label>
                            <div className="flex items-center gap-2">
                              <span className="text-sm">$</span>
                              <Input
                                id="buildingCost"
                                ...
                                placeholder="Auto-extracted from contract"
                                className="flex-1 bg-muted"
                              />
                            </div>
                          </div>
                          <div>
                            <Label htmlFor="checkCostCompliance">Check Cost Compliance</Label>
                            <div className="flex items-center space-x-2">
                              <Badge variant={formData.tbeDetails?.checkCostCompliance === 'compliant' ? 'default' : 'destructive'}>
                                {formData.tbeDetails?.checkCostCompliance === 'compliant' ? 'Compliant' : 'Non-Compliant'}
                              </Badge>
                              <Button 
                                type="button"
                                variant="outline"
                                size="sm"
                                onClick={() => {
                                  // Auto-check cost compliance logic
                                  const buildingCost = formData.tbeDetails?.buildingCost || 0;
                                  const currentRate = 2800; // Current building rate per sqm
                                  const totalArea = parseFloat(formData.livingArea || '0');
                                  const expectedCost = currentRate * totalArea;
                                  const variance = Math.abs(buildingCost - expectedCost) / expectedCost;
                                  
                                  handleInputChange('tbeDetails', {
                                    ...formData.tbeDetails,
                                    checkCostCompliance: variance <= 0.15 ? 'compliant' : 'non-compliant',
                                    checkCostComments: variance <= 0.15 
                                      ? 'Building cost is within acceptable range (+/- 15%) of current market rates.'
                                      : `Building cost variance of ${(variance * 100).toFixed(1)}% exceeds acceptable range. Current market rate: $${currentRate}/sqm. Expected cost: $${expectedCost.toLocaleString()}.`
                                  });
                                }}
                              >
                                Check Cost
                        ...
                        <div>
                          <Label htmlFor="checkCostComments">Check Cost Comments</Label>
                          <Textarea
                            id="checkCostComments"
                            value={formData.tbeDetails?.checkCostComments || ''}
                            onChange={(e) => handleInputChange('tbeDetails', {
                              ...formData.tbeDetails,
                              checkCostComments: e.target.value
                            })}
                            placeholder="Auto-generated cost compliance comments"
                            className="min-h-[100px]"
                          />
                        </div>
                      </div>

                      {/* Progress Payment Schedule Section */}
                      <div className="border-t border-orange-300 pt-4 mt-4">
                        <h4 className="text-lg font-semibold mb-4 text-orange-800">Progress Payment Schedule</h4>
                        
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <Label htmlFor="progressPaymentSchedule">Progress Payment Schedule Supplied</Label>
                            <Select 
                              value={formData.tbeDetails?.progressPaymentSchedule || ''} 
                              onValueChange={(value) => {
                                handleInputChange('tbeDetails', { 
                                  ...formData.tbeDetails, 
                                  progressPaymentSchedule: value,
                                  progressPaymentComments: value === 'No' 
                                    ? 'Progress Payment Schedule not supplied with building contract. Recommend obtaining detailed payment schedule before settlement.'
                                    : value === 'Yes - Front Loaded'
                                    ? 'Progress Payment Schedule supplied is front end loaded and not in line with HIA standards. Payments exceed work completed percentage which increases project risk.'
                                    : 'Progress Payment Schedule supplied and complies with HIA standards with payments aligned to actual work completion stages.'
                                });
                              }}
                            >
                              <SelectTrigger>
                              ...
                              <SelectContent>
                                <SelectItem value="Yes - Compliant">Yes - HIA Compliant</SelectItem>
                                <SelectItem value="Yes - Front Loaded">Yes - Front Loaded</SelectItem>
                                <SelectItem value="No">No</SelectItem>
                              </SelectContent>
                            </Select>
                          </div>
                          <div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <Input
                                ...
                                onChange={(e) => handleInputChange('tbeDetails', {
                                  ...formData.tbeDetails,
                                  outOfContractItems: Number(e.target.value)
                                })}
                        ...
                        <div>
                          <Label htmlFor="progressPaymentComments">Progress Payment Comments</Label>
                          <Textarea
                            id="progressPaymentComments"
                            value={formData.tbeDetails?.progressPaymentComments || ''}
                            onChange={(e) => handleInputChange('tbeDetails', {
                              ...formData.tbeDetails,
                              progressPaymentComments: e.target.value
                            })}
                            placeholder="Auto-generated payment schedule comments"
                            className="min-h-[100px]"
                          />
                        </div>
                      </div>

                      {/* Automated Risk Ratings Section */}
                      <div className="border-t border-orange-300 pt-4 mt-4">
                        <h4 className="text-lg font-semibold mb-4 text-orange-800">Automated Risk Analysis & VRA</h4>
                        
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <Label htmlFor="constructionRiskRating">Construction Risk Rating</Label>
                            <Select 
                              value={formData.tbeDetails?.constructionRiskRating || ''} 
                              onValueChange={(value) => handleInputChange('tbeDetails', {
                                ...formData.tbeDetails,
                                constructionRiskRating: value
                              })}
                            >
                              <SelectTrigger>
                                <SelectValue placeholder="Auto-generated risk rating" />
                              </SelectTrigger>
                              <SelectContent>
                          ...
                          <div>
                            <Label htmlFor="vraCompliance">VRA Compliance</Label>
                            <div className="flex items-center space-x-2">
                              <Badge variant={formData.tbeDetails?.vraCompliance === 'compliant' ? 'default' : 'destructive'}>
                                {formData.tbeDetails?.vraCompliance === 'compliant' ? 'Compliant' : 'Non-Compliant'}
                              </Badge>
                              <Button 
                                type="button"
                                variant="outline"
                                size="sm"
                                onClick={() => {
                                  // Auto-generate VRA compliance based on standard instructions
                                  const hasProgressSchedule = formData.tbeDetails?.progressPaymentSchedule?.includes('Yes');
                                  const hasBuilderLicense = formData.tbeDetails?.builderLicense?.length > 0;
                                  const hasCouncilApproval = formData.tbeDetails?.councilApprovals === 'Approved';
                                  const riskAllowance = formData.tbeDetails?.riskAllowance || 0;
                                  
                                  const isCompliant = hasProgressSchedule && hasBuilderLicense && hasCouncilApproval && riskAllowance >= 10;
                                  
                                  handleInputChange('tbeDetails', {
                                    ...formData.tbeDetails,
                                    vraCompliance: isCompliant ? 'compliant' : 'non-compliant',
                                    vraComments: isCompliant 
                                      ? 'VRA requirements met: Progress payment schedule provided, builder licensed, council approvals obtained, adequate risk allowance applied.'
                                      : 'VRA non-compliance identified. Missing: ' + [
                                          !hasProgressSchedule ? 'Progress payment schedule' : '',
                                          !hasBuilderLicense ? 'Builder license verification' : '',
                                          !hasCouncilApproval ? 'Council approvals' : '',
                                          riskAllowance < 10 ? 'Adequate risk allowance (minimum 10%)' : ''
                                        ].filter(Boolean).join(', ')
                                  });
                                }}
                              >
                        ...
                        <div>
                          <Label htmlFor="vraComments">VRA Compliance Comments</Label>
                          <Textarea
                            id="vraComments"
                            value={formData.tbeDetails?.vraComments || ''}
                            onChange={(e) => handleInputChange('tbeDetails', {
                              ...formData.tbeDetails,
                              vraComments: e.target.value
                            })}
                            placeholder="Auto-generated VRA compliance assessment"
                            className="min-h-[100px]"
                          />
                        </div>
                      </div>
              ...
              <div className="space-y-6 border-t pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="marketability">Marketability</Label>
                      <Select value={formData.marketability} onValueChange={(value) => handleInputChange('marketability', value)}>
                        <SelectTrigger>
                    ...
                    <div>
                      <Label htmlFor="heritageIssues">Heritage Issues</Label>
                      <Select value={formData.heritageIssues} onValueChange={(value) => handleInputChange('heritageIssues', value)}>
                        <SelectTrigger>
                    ...
                    <div>
                      <Label htmlFor="environmentalIssues">Environmental Issues</Label>
                      <Select value={formData.environmentalIssues} onValueChange={(value) => handleInputChange('environmentalIssues', value)}>
                        <SelectTrigger>
                    ...
                    <div>
                      <Label htmlFor="essentialRepairs">Essential Repairs</Label>
                      <Select value={formData.essentialRepairs} onValueChange={(value) => handleInputChange('essentialRepairs', value)}>
                        <SelectTrigger>
                    ...
                    <div>
                      <Label htmlFor="estimatedCost">Estimated Cost {formData.reportType === 'AS IF COMPLETE' ? '(Building Cost)' : ''}</Label>
                      <Input
                        id="estimatedCost"
                        placeholder="Enter estimated cost if applicable"
                        value={formData.estimatedCost}
              ...
              {/* Property Summary */}
              <div className="space-y-6 border-t pt-6">
                <h2 className="text-xl font-semibold">Land & Dwelling Details</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Describe property identification details..."
                    ...
                    <div>
                      ...
                      <Textarea
                        id="zoningEffect"
                        placeholder="Describe zoning and its effect on the property..."
                    ...
                    <div>
                      ...
                      <Textarea
                        id="location"
                        placeholder="Describe the location and accessibility..."
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Textarea
                        id="neighbourhood"
                        placeholder="Describe the neighbourhood characteristics..."
                    ...
                    <div>
                      <Label htmlFor="siteAndAccess">Site & Access</Label>
                      <Textarea
                        id="siteAndAccess"
                        placeholder="Describe site features and access..."
                        value={formData.siteAndAccess}
                        onChange={(e) => handleInputChange('siteAndAccess', e.target.value)}
                        className="min-h-[100px]"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        id="services"
                        placeholder="List available services (electricity, water, sewer, etc.)..."
              ...
              <div className="space-y-6 border-t pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="propertyRiskRatings">Property Risk Ratings</Label>
                    <Textarea
                      id="propertyRiskRatings"
                      placeholder="Enter property risk assessment..."
                      value={formData.propertyRiskRatings}
                      onChange={(e) => handleInputChange('propertyRiskRatings', e.target.value)}
                      className="min-h-[150px]"
                    />
                  </div>
                  
                  <div>
                    <Label htmlFor="marketRiskRatings">Market Risk Ratings</Label>
                    <Textarea
                      id="marketRiskRatings"
                      placeholder="Enter market risk assessment..."
                      value={formData.marketRiskRatings}
                      onChange={(e) => handleInputChange('marketRiskRatings', e.target.value)}
                      className="min-h-[150px]"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-6 border-t pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="interestValued">Interest</Label>
                      <Input
                        id="interestValued"
                        placeholder="Fee Simple Vacant Possession"
                        value={formData.interestValued}
                        onChange={(e) => handleInputChange('interestValued', e.target.value)}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Input
                        id="valueComponent"
                        placeholder="Existing Property"
                        value={formData.valueComponent}
                        onChange={(e) => handleInputChange('valueComponent', e.target.value)}
                      />
                    </div>

                    <div>
                      <Label htmlFor="rentalAssessment">Rental Assessment (per week)</Label>
                      <div className="flex items-center gap-2">
                        <span className="text-sm">$</span>
                        <Input
                          id="rentalAssessment"
                          ...
                          placeholder="650"
                          value={formData.rentalAssessment}
                          onChange={(e) => handleInputChange('rentalAssessment', e.target.value)}
                          className="flex-1"
                        />
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Input
                          ...
                          placeholder="400000"
                          value={formData.insuranceEstimate}
                          onChange={(e) => handleInputChange('insuranceEstimate', e.target.value)}
                          className="flex-1"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      <Label htmlFor="improvementValue">Improvements Value</Label>
                      <div className="flex items-center gap-2">
                        <span className="text-sm">$</span>
                        <Input
                          id="improvementValue"
                          ...
                          placeholder="450000"
                          value={formData.improvementValue}
                          onChange={(e) => handleInputChange('improvementValue', e.target.value)}
                          className="flex-1"
                        />
                      </div>
                    </div>
              ...
              <div className="space-y-6 border-t pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Textarea
                      placeholder="Enter any special considerations or notes..."
            ...
            <TabsContent value="photos" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Upload property photos. Minimum {getMinPhotoRequirement()} photos required for {getPropertyType()} properties.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            ...
                            >
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="living">Living Area</SelectItem>
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                      ...
                      <p className="text-sm text-gray-600">
                        Photos uploaded: {formData.photos.length} / Minimum required: {getMinPhotoRequirement()}
                      </p>
                      {formData.photos.length >= getMinPhotoRequirement() && (
                        <p className="text-sm text-green-600 mt-1">✓ Minimum photo requirements met</p>
                      )}
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Upload building contract, plans, permits and other supporting documents.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
              ...
              {/* OCR Document Processing Section */}
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Scan className="h-5 w-5" />
                  ...
                  <CardDescription>
                    Process uploaded documents with OCR to extract key information automatically.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                      ...
                      <Button
                        ...
                        className="mb-2"
                      >
                        {isOCRProcessing ? "Processing..." : "Upload for OCR Processing"}
                      </Button>
                      <p className="text-sm text-gray-600">
                        Upload contracts, permits, or documents for automatic data extraction
                      </p>
                    </div>
                          ...
                          <div key={index} className="border rounded-lg p-4">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <Badge variant="outline">
                                {result.confidence > 80 ? 'High Confidence' : 'Medium Confidence'}
                              </Badge>
                            </div>
            ...
            <TabsContent value="automation" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Automated processes for data extraction, validation, and report generation.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="text-center p-4 border rounded-lg">
                        <div className="text-2xl font-bold text-blue-600">{formData.automation.progress}%</div>
                        <div className="text-sm text-gray-600">Automation Progress</div>
                      </div>
                      <div className="text-center p-4 border rounded-lg">
                        <div className="text-2xl font-bold text-green-600">
                          {formData.automation.reportGenerated ? '✓' : '○'}
                        </div>
                        <div className="text-sm text-gray-600">Report Status</div>
                      </div>
                      <div className="text-center p-4 border rounded-lg">
                        <div className="text-2xl font-bold text-purple-600">{formData.photos.length}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <Button
                        type="button"
                        onClick={processPropertyValuation}
                        disabled={isProcessing}
                        className="h-12"
                      >
                        {isProcessing ? (
                    ...
                    {reportUrl && (
                      <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                        <div className="flex items-center justify-between">
                          <div>
                            <h4 className="font-medium text-green-800">Report Ready</h4>
                            <p className="text-sm text-green-600">Your ISFV report has been generated successfully.</p>
                          </div>
                          <Button
                            type="button"
                    ...
                    {/* Automation Log */}
                    <div>
                      <h4 className="font-medium mb-3">Automation Log</h4>
                      <div className="border rounded-lg p-4 bg-gray-50 max-h-64 overflow-y-auto">
                        {formData.automation.logs.length === 0 ? (
                          <p className="text-gray-500 text-sm">No automation logs yet. Start by running property valuation.</p>
                        ) : (
