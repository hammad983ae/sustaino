        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-4 items-center py-2">
              ...
              <Input placeholder="01st March 2024" className="text-sm" />
            ...
            <div className="grid grid-cols-4 gap-4 items-center py-2">
              ...
              <Input placeholder="6 months rent-free, fit-out contribution" className="text-sm" />
            ...
            <div className="grid grid-cols-4 gap-4 items-center py-2">
              ...
              <Input placeholder="5 year initial + 5 year option" className="text-sm" />
            ...
            <div className="grid grid-cols-4 gap-4 items-center py-2">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="fixed-percentage">Fixed %</SelectItem>
            ...
            <div className="grid grid-cols-4 gap-4 items-center py-2">
              ...
              <Input placeholder="$120,000 per annum" className="text-sm" />
            ...
            <div className="grid grid-cols-4 gap-4 items-center py-2">
              ...
              <Input placeholder="$110,000 per annum (after incentives)" className="text-sm" />
            ...
            <div className="grid grid-cols-4 gap-4 items-center py-2">
              ...
              <Input placeholder="$135,000 per annum gross" className="text-sm" />
            ...
            <div className="grid grid-cols-4 gap-4 items-center py-2">
              ...
              <Input placeholder="$8,500 per annum" className="text-sm" />
            ...
            {/* Rates Per Sqm */}
            <div className="grid grid-cols-4 gap-4 items-center py-2">
              <Label>Rates Per Sqm</Label>
              <div className="flex justify-center">
                <Switch checked={ratesPerSqm} onCheckedChange={setRatesPerSqm} />
              </div>
              <div className="flex gap-2">
                <Input placeholder="267" className="text-sm" />
                <Select>
            ...
            <div className="grid grid-cols-4 gap-4 items-center py-2">
              ...
              <Input placeholder="NABERS 4.5 stars, solar panels, EV charging" className="text-sm" />
            ...
            <div className="grid grid-cols-4 gap-4 items-center py-2">
              ...
              <Input placeholder="Single tenant, multi-tenant" className="text-sm" />
