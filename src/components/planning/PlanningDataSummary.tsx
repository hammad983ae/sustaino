    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 mb-4 lg:mb-6">
        <div className="p-3 bg-primary/5 border border-primary/20 rounded-lg">
          ...
          <p className="text-xs lg:text-sm text-muted-foreground break-words">{planningData.zoneName}</p>
        </div>
        <div className="p-3 bg-success/5 border border-success/20 rounded-lg">
          ...
          <p className="text-xs lg:text-sm text-muted-foreground break-words">{planningData.developmentPotential}</p>
        </div>
        <div className="p-3 bg-amber/5 border border-amber/20 rounded-lg">
          ...
          <p className="text-xs lg:text-sm text-muted-foreground">{planningData.overlays?.length || 0} Active</p>
        </div>
        <div className="p-3 bg-blue/5 border border-blue/20 rounded-lg">
          ...
          <p className="text-xs lg:text-sm text-muted-foreground break-words">{planningData.planningScheme}</p>
        </div>
      </div>

      {/* Planning Data Retrieved Section */}
      <div className="p-3 lg:p-4 bg-success/5 border border-success/20 rounded-lg">
        <h4 className="font-medium mb-3 text-success-foreground text-sm lg:text-base">Planning Data Retrieved & Saved</h4>
