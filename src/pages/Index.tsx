              ...
              <div className="max-w-7xl mx-auto">
                <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value)} className="w-full">
                  <div className="space-y-4">
                    ...
                    {/* Second row of tabs */}
                    <TabsList className="grid w-full grid-cols-3 max-w-4xl mx-auto bg-white/80 backdrop-blur-sm shadow-sm border border-purple-200/50 rounded-xl p-1">
                  ...
                  <TabsContent value="assessment" className="mt-8">
                    <div className="max-w-7xl mx-auto">
                      <Card className="bg-white/95 border border-purple-200/50">
